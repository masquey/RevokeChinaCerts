...
CertMgr_x86 -del -c -sha1 3E14B8BD6C568657D852D95D387249AE857B4A39 -s Disallowed
::  WoSign SGC Server Authority(USERTrust)
CertMgr_x86 -del -c -sha1 6D5A18050D56BFDE525CBE89E8C45DD1B53D12E9 -s Disallowed
::  WoTrust Premium Server Authority(USERTrust)
CertMgr_x86 -del -c -sha1 381CBC5048AFD9A02D3E5882D5F22D962B1A5F72 -s Disallowed
::  WoTrust Server Authority(USERTrust)
CertMgr_x86 -del -c -sha1 337DF96418F08A9355870513AFCEBDC68BCED767 -s Disallowed
::  WoTrust SGC Server Authority(USERTrust)
CertMgr_x86 -del -c -sha1 46A762F3C3CF3732DE22A8BA1EBBA3BC048F9B8C -s Disallowed
