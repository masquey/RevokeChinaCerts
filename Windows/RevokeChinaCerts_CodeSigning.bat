...
cd /d "%~dp0"
set CertMgr="%cd%\Tools\CertMgr.exe"
...
%CertMgr% -add -c %Folder%\Beijing_Baidu_Netcom_Science_And_Technology_CoLtd_201202.crt" -s Disallowed
::  Beijing Baidu Netcom science and technology co.ltd(2015-02-05)
%CertMgr% -add -c %Folder%\Beijing_Baidu_Netcom_Science_And_Technology_CoLtd_201502.crt" -s Disallowed
::  Beijing Baofeng Technology Co., Ltd.(2012-02-22)
%CertMgr% -add -c %Folder%\Beijing_Baofeng_Technology_CoLtd_201202.crt" -s Disallowed
::  Beijing Baofeng Technology Co., Ltd.(2015-02-05)
%CertMgr% -add -c %Folder%\Beijing_Baofeng_Technology_CoLtd_201502.crt" -s Disallowed
...
if /i %UserChoice% EQU Y (if %SetForce% EQU 0 (%CertMgr% -add -c %Folder%\Beijing_Baidu_Netcom_Science_And_Technology_CoLtd_201202.crt" -s Disallowed) else (%SetForceAppender% --set-force %Folder%\Beijing_Baidu_Netcom_Science_And_Technology_CoLtd_201202.crt"))
echo.
set /p UserChoice="Revoke Beijing baidu Netcom science and technology co.ltd(2015-02-05)? [Y/N]"
if /i %UserChoice% EQU Y (if %SetForce% EQU 0 (%CertMgr% -add -c %Folder%\Beijing_Baidu_Netcom_Science_And_Technology_CoLtd_201502.crt" -s Disallowed) else (%SetForceAppender% --set-force %Folder%\Beijing_Baidu_Netcom_Science_And_Technology_CoLtd_201502.crt"))
echo.
set /p UserChoice="Revoke Beijing Baofeng Technology Co., Ltd.(2012-02-22)? [Y/N]"
if /i %UserChoice% EQU Y (if %SetForce% EQU 0 (%CertMgr% -add -c %Folder%\Beijing_Baofeng_Technology_CoLtd_201202.crt" -s Disallowed) else (%SetForceAppender% --set-force %Folder%\Beijing_Baofeng_Technology_CoLtd_201202.crt"))
echo.
set /p UserChoice="Revoke Beijing Baofeng Technology Co., Ltd.(2015-02-05)? [Y/N]"
if /i %UserChoice% EQU Y (if %SetForce% EQU 0 (%CertMgr% -add -c %Folder%\Beijing_Baofeng_Technology_CoLtd_201502.crt" -s Disallowed) else (%SetForceAppender% --set-force %Folder%\Beijing_Baofeng_Technology_CoLtd_201502.crt"))
echo.
...
::  Beijing Baidu Netcom science and technology co.ltd(2015-02-05)
%CertMgr% -del -c -sha1 03FCF1B9FCAB6F7243F3E3E011C6FD28F64F9920 -s Disallowed
::  Beijing Baofeng Technology Co., Ltd.(2012-02-22)
%CertMgr% -del -c -sha1 CB6F65314E5B25D61304AB2C9C8870B574CC21F5 -s Disallowed
::  Beijing Baofeng Technology Co., Ltd.(2015-02-05)
%CertMgr% -del -c -sha1 CC79F55AB07E7A1D5CEC981CEEB864DDA5DC74E3 -s Disallowed
::  Beijing Funshion Online Technologies Ltd.
